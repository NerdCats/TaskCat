namespace TaskCat.Data.Model.Geocoding.Tests.Model.Geocoding
{
    ...
    public class DefaultAddressTests
    {
        ...
        {
            addressWithFormattedString = new DefaultAddress("Test Formatted Address", new GeoJson.Point(new double[] { 1, 2 }.ToList()));
            Assert.AreEqual("Test Formatted Address", addressWithFormattedString.Address);

            address = new DefaultAddress("Test AddressLine 1", "Test AddressLine 2", "Dhaka", "1217", "Bangladesh", new GeoJson.Point(new double[] { 1, 2 }.ToList()));
            address.State = "Dhaka";
        ...
        public void Test_DefaultAddress_Creation_Without_AddressLine()
        {
            Assert.Throws<ArgumentException>(()=> {
                address = new DefaultAddress("", "Test AddressLine 2", "Dhaka", "1217", "Bangladesh", new GeoJson.Point(new double[] { 1, 2 }.ToList()));
            });            
        }
    }
}